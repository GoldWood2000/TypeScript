...
var Crowller = /** @class */ (function () {
    function Crowller(filepath, url, analyze) {
        this.filepath = filepath;
        this.url = url;
        this.initCrowllerProcess(analyze);
    }
    Crowller.prototype.initCrowllerProcess = function (analyze) {
    ...
    Crowller.prototype.getRawHtml = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios.get(this.url)];
                    case 1:
                        result = _a.sent();
    ...
    Crowller.prototype.writeJson = function (content) {
